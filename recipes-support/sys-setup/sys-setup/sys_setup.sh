...
# eMMC on i.MX 8MM EVK
s_block="/dev/mmcblk2p3" # /dev/mmcblk1p3 for SD Card
mpoint="/dmblk"
...
caam-keygen import /data/caam/enckey.bb enckey
...
After=local-fs.target psplash-quit.service
